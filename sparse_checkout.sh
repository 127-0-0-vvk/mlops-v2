...
git_folder_location='/home/127-0-0-vvk/mlops-v2'   #replace with the local root folder location where you want to create the project folder
project_name=Mlops-infra   #replace with your project name
github_org_name=smurffers   #replace with your github org name
...
orchestration=github-actions #options: github-actions
